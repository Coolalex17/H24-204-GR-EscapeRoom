...
/// </summary>
public class InteractibleKeypadExecuterClasse : MonoBehaviour, Interactible
{
    [SerializeField] private KeypadClasse keypadClasse; // Clavier.
    ...
    public void BoutonPresse()
    {
        ...
        if (!keypadClasse.IsReponseTrouvee())
        {
            keypadClasse.Executer(); // Exécute le code tapé par le joueur pour vérifier s'il a la bonne réponse.
        }
    }
