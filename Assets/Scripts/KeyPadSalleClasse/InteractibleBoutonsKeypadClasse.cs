...
/// </summary>
public class InteractibleBoutonsKeypadClasse : MonoBehaviour, Interactible
{
    ...
    public void BoutonPresse()
    {
        ...
        {
            keypadClasse.Nombre(nombre); // Ajoute le nombre associé au bouton au texte du clavier.
        }
    }
